...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('china-ems','LY589648455CN',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "LY589648455CN",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("china-ems","LY589648455CN",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'LY589648455CN',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('china-ems','LY589648455CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('china-ems','LY589648455CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("china-ems","LY589648455CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("LY589648455CN","china-ems","china-post");
...
//$date = array();
//$data[] = array("tracking_number"=>"LY589648455CN","carrier_code"=>"china-ems");
...
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"china-post");
//$track = $track->getCarrierCostTime($data);

//16 Delete multiple tracking item (删除多个单号)
// $date = array();
// $data[] = array("tracking_number"=>"LY589648455CN","carrier_code"=>"china-ems");
// $data[] = array("tracking_number"=>"RP325552475CN","carrier_code"=>"china-post");
